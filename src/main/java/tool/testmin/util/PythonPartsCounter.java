...
import tool.parser.python3.Python3Listener;
...
public class PythonPartsCounter implements Python3Listener {
    ...
    public PythonPartsCounter(String testfile) {
        this(Util.getPythonParser(testfile));
    }
    ...
    public static int CountFromString(String content) {
        PythonPartsCounter pythonPartsCounter = new PythonPartsCounter(Util.getPython3ParserFromString(content));
