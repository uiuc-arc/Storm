...
public class ParamUseTracker extends TemplateBaseTransformer {
    ...
    public static void GetUnusedParams(String filename) {
        ...
        ArrayList<ParserRuleContext> parameters = TemplateScraper.scrape(Util.getTemplateParser(filename), "prior", "");
        ArrayList<ParserRuleContext> transformedparameters = TemplateScraper.scrape(Util.getTemplateParser(filename), "decl", "transformedparam");
        ArrayList<ParserRuleContext> generatedquantities = TemplateScraper.scrape(Util.getTemplateParser(filename), "decl", "generatedquantities");
        ...
        ParamUseTracker paramUseTracker = new ParamUseTracker(Util.getTemplateParser(filename), null, parameterMap);
