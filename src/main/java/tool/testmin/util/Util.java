...
import tool.parser.StanLexer;
import tool.parser.StanParser;
import tool.parser.python3.Python3Lexer;
import tool.parser.python3.Python3Parser;
import tool.parser.template.Template2Lexer;
...
public class Util {
    ...
    static {
        ...
        try {
            InputStream fileInputStream = Util.class.getClassLoader().getResourceAsStream("config.properties");
    ...
    public static boolean runTransformedCode(String curFileContent,
        ...
        try {
            if (newContent.equals(curFileContent) && !datachanged) {
                ...
                Util.updateTransformations(testFile.getTestfile(), transformer, false);
                Util.updateCompileTime(testFile.getTestfile(), 0L);
                return false;
            }
            ...
            Util.updateCompileTime(testfile, compileTime);
...
//                }
                Util.updateTransformations(testfile, transformer, true);
//                Util.updateReductionCount(testfile, transformer, curFileContent, newContent);
                ...
                Util.updateReductionCount(testfile, transformer, oldstancode, newstancode);
            } else {
                // Recovery phase
...
//                }
                ...
                Util.updateTransformations(testfile, transformer, false);
                return false;
            }
    ...
    public static boolean runTransformedCode(String curFileContent,
        ...
        try {
            if (newContent.equals(curFileContent) && !datachanged) {
                ...
                logger.print("No changes... returning", true);
                Util.updateTransformations(testfile, transformer, false);
                Util.updateCompileTime(testfile, 0L);
                return false;
            }
