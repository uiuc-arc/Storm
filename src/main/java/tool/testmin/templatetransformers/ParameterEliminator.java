...
import static tool.testmin.util.Util.getParamName;
            ...
            try {
                ...
                for (int l = 0; l < priors.size(); ) {
                    ...
                    if (l > curPriors.size() - 1)
                        break;
                    ParamReplacer paramReplacer = new ParamReplacer(Util.getTemplateParserFromString(filecontent),
                            logger,
                    ...
                    ParameterEliminator parameterEliminator = new ParameterEliminator(Util.getTemplateParserFromString(filecontent), logger);
                    ...
                    if (parameterEliminator.modifiedTree &&
                            Util.runTransformedCode(filecontent,
                                    newContent,
                                    Util.TemplateTransformationMap.inverse().get(ParameterEliminator.class),
                                    logger,
                                    testFile)) {
