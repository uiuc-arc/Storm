                ...
                for (int l = 0; l < adds; ) {
                    ...
                    if (arithEliminator.modifiedTree &&
                            Util.runTransformedCode(filecontent,
                                    newContent,
                                    Util.TemplateTransformationMap.inverse().get(ArithEliminator.class),
                                    logger,
                                    testFile)) {
            ...
            if (this.op == '+') {
                ...
                if (this.count == 0) {
                    if (this.analyse) {
                        ...
                        boolean isPrimitive0 = Util.isPrimitive(ctx.expr(0), program);
                        boolean isPrimitive1 = Util.isPrimitive(ctx.expr(1), program);
